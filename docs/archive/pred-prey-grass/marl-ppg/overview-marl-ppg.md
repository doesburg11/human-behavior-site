...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/pred-prey-grass/marl-ppg/overview-marl-ppg/display-1.jpg" alt="Display 1: Single Agent Reinforcement learning" width="400" />
  <figcaption><strong>Display 1:</strong> Single Agent Reinforcement Learning</figcaption>
</figure>
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/pred-prey-grass/marl-ppg/overview-marl-ppg/display-2.jpg" alt="Display 2: Multi Agent Reinforcement learning" width="400" />
