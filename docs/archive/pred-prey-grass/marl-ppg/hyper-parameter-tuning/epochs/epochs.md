...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/pred-prey-grass/marl-ppg/hyper-parameter-tuning/epochs/display-1.png" alt="Display 1: Training results (iterations): ```num_epochs=30,20,10,5```" width="1200" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/pred-prey-grass/marl-ppg/hyper-parameter-tuning/epochs/display-2-a.png" alt="Display 2: Training results (iterations): ```num_epochs=30,20,10,5```" width="1200" />
  <img src="/img/archive/pred-prey-grass/marl-ppg/hyper-parameter-tuning/epochs/display-2-b.png" alt="Display 2: Training results (iterations): ```num_epochs=30,20,10,5```" width="1200" />
