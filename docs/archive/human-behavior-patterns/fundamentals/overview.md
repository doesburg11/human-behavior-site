...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/fundamentals/overview/display-1.jpg" alt="Display 1: Behavior and its fundamentals" width="400" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/fundamentals/overview/display-2.jpg" alt="Display 2: Historic origins of behavior" width="800" />
