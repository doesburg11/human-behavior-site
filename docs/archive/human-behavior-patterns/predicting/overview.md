...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/predicting/display-1.jpg" alt="Display 1: Street calculus" width="400" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/predicting/display-2.jpg" alt="Display 2: Reinforcement learning" width="400" />
