...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/machinery/overview/display-1.jpg" alt="Display 1: Reflexive response" width="800" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/machinery/overview/display-2.jpg" alt="Display 2: Low road versus high road response" width="500" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/archive/human-behavior-patterns/machinery/overview/display-3.jpg" alt="Display 3: Schematic overview of the three response pathways" width="500" />
