...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/pred-prey-grass/marl-ppg/environment-configurations/display-1.png" alt='Display 1: Action spaces "slow" and "fast" agents' width="500" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/pred-prey-grass/marl-ppg/environment-configurations/display-2.png" alt="Display 2: Tensorboard training results" width="800" />
...
<figure style={{ textAlign: 'center' }}>
  <img src="/img/pred-prey-grass/marl-ppg/environment-configurations/display-3.png" alt="Display 3: Low-speed agents replaced by high-Speed agents trough selection" width="400" />
  <figcaption><strong>Display 3:</strong> Low-speed agents replaced by high-Speed agents trough selection</figcaption>
</figure>
